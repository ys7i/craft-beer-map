    ...
    return __generator(this, (_a) => {
      switch (_a.label) {
        ...
        case 1:
          ...
          return [
            4 /*yield*/,
            places_1.placesApi.searchRestaurants(
              {
                latitude: center.lat,
        ...
        case 2:
          ...
          console.log(
            "Found "
              .concat(result.restaurants.length, " restaurants for ")
              .concat(prefecture, " (total: ")
              .concat(allRestaurants.length, ")"),
          );
        ...
        case 5:
          error_1 = _a.sent();
          console.error(
            "Error fetching data for ".concat(prefecture, ":"),
            error_1,
          );
          return [3 /*break*/, 7];
        case 6:
    ...
    return __generator(this, (_c) => {
      switch (_c.label) {
        ...
        case 1:
          ...
          _c.label = 2;
        case 2:
          _c.trys.push([2, 5, undefined, 6]);
          return [
            4 /*yield*/,
            fetchRestaurantsForPrefecture(prefecture, center),
          ];
        case 3:
          data = _c.sent();
          filePath = path_1.default.join(
            OUTPUT_DIR,
            "".concat(center.code, ".json"),
          );
          fs_1.default.writeFileSync(filePath, JSON.stringify(data, null, 2));
          results[prefecture] = data.count;
          console.log(
            "Saved "
              .concat(data.count, " restaurants to ")
              .concat(center.code, ".json"),
          );
